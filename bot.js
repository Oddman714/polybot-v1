// POLYBOT — Railway Server v9.6 — multi-category markets + dedup fix + upgraded Claude prompt
...
async function fetchMarkets() {
  ...
  // Category endpoints — pull specifically from high-quality market categories
  // These ensure Claude sees contested political, sports, and crypto markets
  const categoryEndpoints = [
    'https://gamma-api.polymarket.com/markets?active=true&closed=false&limit=50&tag=politics',
    'https://gamma-api.polymarket.com/markets?active=true&closed=false&limit=50&tag=sports',
    'https://gamma-api.polymarket.com/markets?active=true&closed=false&limit=50&tag=crypto',
    'https://gamma-api.polymarket.com/markets?active=true&closed=false&limit=50&tag=economics',
    'https://gamma-api.polymarket.com/markets?active=true&closed=false&limit=30&tag=science',
  ];
