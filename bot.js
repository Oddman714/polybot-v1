...
const CFG = {
  ...
  adminSecret: process.env.ADMIN_SECRET   || 'changeme',  // set in Railway!
  maxDailyLoss: parseFloat(process.env.MAX_DAILY_LOSS) || 50, // auto-stop if lost $50/day
};
...
const STATE = {
  ...
  openPositions: {},  // dedup: key = trader+market+side
  dailyLoss:  0,      // resets at midnight
  dailyReset: new Date().toDateString(),
  stopped:    false,  // emergency stop flag
  clobApiKey: null,
}
